 ...
 */
typedef void (acc_power_bins_callback_t)(const acc_service_handle_t service_handle, const float *data,
                                         const acc_service_power_bins_result_info_t *result_info, void *user_reference);
 ...
 */
extern void acc_service_power_bins_power_bins_callback_set(acc_service_configuration_t service_configuration,
                                                           acc_power_bins_callback_t *power_bins_callback, void *user_reference);
 ...
 */
extern acc_service_status_t acc_service_power_bins_get_next(acc_service_handle_t handle, float *data, uint16_t data_length,
 ...
 * @return Service status
 */
extern acc_service_status_t acc_service_power_bins_execute_once(acc_service_handle_t handle, float *data, uint16_t data_length,
                                                                acc_service_power_bins_result_info_t *result_info);
