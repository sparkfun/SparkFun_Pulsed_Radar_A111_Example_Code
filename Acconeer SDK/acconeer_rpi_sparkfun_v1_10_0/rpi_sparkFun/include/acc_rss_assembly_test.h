...
#define ACC_RSS_ASSEMBLY_TEST_MAX_NUMBER_OF_TESTS (20)
 ...
 * @return Sensor id
 */
acc_sensor_id_t acc_rss_assembly_test_configuration_sensor_get(const acc_rss_assembly_test_configuration_t configuration);
 ...
 *
 * This function executes a suite of tests suitable for customer assembly testing.
 *
