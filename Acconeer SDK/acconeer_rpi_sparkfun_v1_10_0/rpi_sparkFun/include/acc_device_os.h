...
/**
 * @brief Measure amount of used heap in bytes
 *
 * @param heap_size Total amount of heap bytes
 * @return Number of bytes of used heap space
 */
extern size_t acc_os_heap_get_usage(size_t heap_size);
